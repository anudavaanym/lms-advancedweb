...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="mb-4">
            ...
            <p class="text-gray-700">{{ $task->subject->name ?? 'Not available'}}</p>
        </div>
        ...
        <div class="mb-4">
            ...
            <p class="text-gray-700">{{ $task->subject->teacher->name ?? 'Not available' }} </p>
        </div>
                ...
                <form action="{{ route('solutions.store', $task) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="content" class="block text-gray-700 text-sm font-bold mb-2">
                            {{ $solution ? 'Update Your Solution' : 'Your Solution' }} <span class="text-red-500">*</span>
                        </label>
