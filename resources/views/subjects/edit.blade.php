...
<div class="p-6">
    <div class="mb-6">
        <h1 class="text-3xl font-bold">Edit Subject</h1>
    </div>
        ...
        <form method="POST" action="{{ route('subjects.update', $subject) }}" novalidate>
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('description') border-red-500 @enderror">{{ old('description', $subject->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input id="credit_value" type="number" name="credit_value" value="{{ old('credit_value', $subject->credit_value) }}" required min="1" max="30"
